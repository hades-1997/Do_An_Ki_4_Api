...
--
-- Indexes for table `videos_transiction`
--
ALTER TABLE `videos_transiction`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `playlist_tid` (`playlist_tid`);
...
--
-- AUTO_INCREMENT for table `videos_transiction`
--
ALTER TABLE `videos_transiction`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `videos_transiction`
--
ALTER TABLE `videos_transiction`
  ADD CONSTRAINT `videos_transiction_ibfk_1` FOREIGN KEY (`playlist_tid`) REFERENCES `videos_playlist_cat` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `videos_transiction_ibfk_2` FOREIGN KEY (`id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
